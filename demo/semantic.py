...
semantic_relationship_feature = {
    #person -> drug
    ("person_id", "drug_concept_id", "in_degree") : "Number of distinct drugs the person has been exposed to",
    ("person_id", "drug_concept_id", "out_degree") : "Number of distinct people exposed to the drug",
    ("person_id", "drug_concept_id", "core") : "How well connected the drugs the person take are with other patients as well",
    ("person_id", "drug_concept_id", "weighted_out_degree") : "Quantities of drugs the person was exposed to",
    ("person_id", "drug_concept_id", "weighted_in_degree") : "undefined",
    ("person_id", "drug_concept_id", "weighted_degree") : "Quantities of drugs the person was exposed to",

    #drug -> person
    ("drug_concept_id", "person_id", "in_degree") : "Number of distinct persons exposed to the drug",
    ("drug_concept_id", "person_id", "out_degree") : "Number of distinct drugs the person has been exposed to",
    ("drug_concept_id", "person_id", "core") : "How well connected the people that take the drug are with other drugs as well",
    ("drug_concept_id", "person_id", "weighted_out_degree") : "quantity of this drug people were exposed to",
    ("drug_concept_id", "person_id", "weighted_in_degree") : "undefined",
    ("drug_concept_id", "person_id", "weighted_degree") : "quantity of this drug people were exposed to",
    ...
    ("ingredient_concept_id", "drug_concept_id", "weighted_degree") : "Amount of ingredient that composes drugs",
    ...
    ("drug_concept_id", "ingredient_concept_id", "weighted_degree") : "Amount of ingredients that compose this drug",
    ...
    ("observation_period_id", "person_id", "weighted_degree") : "Amount of people that had this observation period",
    ...
    ("person_id", "observation_period_id", "weighted_degree") : "Amount of observation periods the person had",
    ...
    ("person_id", "procedure_occurrence_id", "weighted_degree") : "Amount of procedures the person was exposed to",
    ...
    ("procedure_occurrence_id", "person_id", "weighted_degree") : "Amount of people exposed to the procedure",
}
